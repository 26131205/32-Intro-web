...
class PokemonFuego extends Pokemon {
    constructor(nombre, nivelAtaque, nivelVida, velocidad, colorFlama){
        // Se manda a llamar el constructor de la clase padre. Los parámetros se deben mandar en el mismo orden del constructor padre.
        super(nombre, nivelAtaque, nivelVida, velocidad); 
